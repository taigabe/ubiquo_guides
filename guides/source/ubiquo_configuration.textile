...
| model_groups                  | Email address used for notifications                                 | railsmail@gnuine.com |
...
| unfold_tabs                   | Allows you to set the ubiquo form builder tabs to be folded or unfolded when using ubiquo_form_builder | +false+ |
