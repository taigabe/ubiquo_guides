...
<ruby>
class ExampleController < UbiquoAreaController
...
the values of the hash is explained in the next three sections.
...
Tt's used with _permit?_ method:
