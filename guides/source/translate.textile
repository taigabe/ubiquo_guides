...
Follow the guide present at the "author's repository":http://github.com/mynewsdesk/translate
...
Each time you translate something (on each *Save translation* using the web interface) a backup log file will be created as *Rails.root/config/log/locale_code/*

The original plugin mechanism throught Translate::Log has been disabled.
