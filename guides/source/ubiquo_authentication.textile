...
<shell>
$ rake ubiquo:create_user
(in /data/storage/acallarisa/development/rails/project_example)
...
you in the defaul locale (+ca_ES+)
...
All controllers inherited from UbiquoAreaController has this
...
UbiquoAreaController you have a validation in every action) you may
