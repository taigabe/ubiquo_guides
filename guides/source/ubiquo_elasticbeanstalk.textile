...
NOTE: This guide has been writing on 31-01-2011 while Elastic Beanstalk it's still in beta. It has not been revised so it may contain errors, if you find them you can report them "here":http://ubiquo.lighthouseapp.com/projects/31609-ubiquo-guides/overview
...
Warbler::Config.new do |config|
  ...
  config.gems += ["activerecord-jdbc-adapter","jdbc-mysql", "jruby-openssl"]
